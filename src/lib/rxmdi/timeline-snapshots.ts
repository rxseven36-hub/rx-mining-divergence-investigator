  ...
  GEMS: {
    ...
    events: [
      ...
      },
      {
        ...
        summary: "PT Dian Swastatika Sentosa Tbk announced a strategic shift toward digital and artificial-intelligence infrastructure, targeting an equal split of revenue between coal and non-coal businesses by 2029. While about 90% of its EBITDA currently comes from coal through its subsidiary PT Golden Energy Mines Tbk, the company projects EBITDA to be 60% coal and 40% non-coal this year and to achieve a 50:50 revenue mix by 2029. It has invested roughly US$2.8 bn (≈Rp50 trillion) in an AI-ready ecosystem, including a fully contracted 40 MW data-center in Jakarta slated to start operations in October 2026. The transformation will also leverage its digital assets such as MyRepublic, Moratelindo, SM+, ASIX, Dana, Video and its stake in XLSMART.",
        source: "Investor.id",
      },
      {
